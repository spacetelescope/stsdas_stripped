...
define	FITS_NAXIS	Memi[$1+14]	# Iraf number of axis
define  EXT_POINTER     Memi[$1+15]     # FITS extension pointer
...
define  EXT_NAXIS	Memi[$1+1]	# Dimensionality of extension
define  EXT_LENAXIS	Memi[$1+$2+2-1] # Length of the axes
define  EXT_TYPE        Memi[$1+9]	# Extension type
define  EXT_DEFFMT	Memi[$1+10]	# For TABLES, use default fmt?
					# values are YES, NO
define  EXT_LINE_MAXLEN Memi[$1+11]	# Maximun line length on FITS TABLE
define  EXT_PCUNDEF     Memi[$1+12]     # Pointer to array of (true,false) for
					# columns with undefined values
define	EXT_PCOL        Memi[$1+13]	# Pointer the array of columns
					# pointers for TABLES
define  EXTVER		Memi[$1+14]	# External version of extension
define  EXT_NCOLS	Memi[$1+15]     # Number of columns in table extension
define  EXT_NROWS       Memi[$1+16]     # Number of rows in table extension
