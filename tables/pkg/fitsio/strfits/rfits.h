...
define	SDASMGNU	Memi[$1+11]	# SDASMGNU keyword present
define  FITS_NROWS	Memi[$1+12]	# Number of lines in table
define  FITS_ROWLEN	Memi[$1+13]	# Number of character per row
define  NAXIS		Memi[$1+14]	# Number of dimensions 
define  NAXISN	 	Memi[$1+15+$2-1] # Length of each axis (up to 7)
define  GCOUNT		Memi[$1+23]
define  OPSIZE          Memi[$1+24]
define  FITS_XTEN       Memi[$1+25]     # Kind of FITS Xtension (TABLE, BINTABLE
					# or IMAGE).
# extra space
...
define  EXT_BITPIX      Memi[$1]        # BITPIX value for extension
define  EXT_ROWLEN      Memi[$1+2]     # Number characters per row
define  EXT_NROWS       Memi[$1+3]     # Number of rows in table extension
define  EXT_PBCOL       Memi[$1+4]     # Pointer the array of columns
define  EXT_PCW     	Memi[$1+5]     # Pointer to array of column widths
define  EXT_PNULL     	Memi[$1+6]     # Pointer to array of null values
define  EXT_PZERO       Memi[$1+7]     # Pointer to array of zero offsets
define  EXT_PSCAL       Memi[$1+8]     # Pointer to array of scaling values
define  EXT_PUNIT       Memi[$1+9]     # Pointer to array of TUNITs values.
define  EXT_PTYPE       Memi[$1+10]    # Pointer to array of TTYPEs values.
define  EXT_PDTYPE      Memi[$1+11]    # Pointer to array of Tdatatype values.
define  EXT_PDSIZE      Memi[$1+12]    # Pointer to array of Tdatatype sizes
				       # or number of elements for a BINTABle
				       # column.
define  EXT_PFORM       Memi[$1+13]    # Pointer to array of TFORMs values.
define  EXT_PDISP       Memi[$1+14]    # Pointer to array of TDISP values.
define  EXTVER          Memi[$1+15]    # External version of extension
define  BIN_DTYNSP	Memb[$1+16]    # Flag to BINTABLE datype not supported.
define  TAB_TYPE	Memi[$1+17]    # ST Table type (tab or ascii)
define  BIN_MAXLEN	Memi[$1+18]    # Maximun number of characters for a
