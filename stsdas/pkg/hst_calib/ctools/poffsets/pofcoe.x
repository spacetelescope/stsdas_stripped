#---------------------------------------------------------------------------
.help pof_correlate Feb93 source
.ih
NAME
pof_correlate -- Cross correlate two one-dimensional data vectors.
.ih
USAGE
call pof_correlate (a1, a2, length, n_sections, maxd, cc)
.ih
ARGUMENTS
...
.endhelp
#---------------------------------------------------------------------------
procedure pof_correlate (a1, a2, length, n_sections, maxd, cc)
