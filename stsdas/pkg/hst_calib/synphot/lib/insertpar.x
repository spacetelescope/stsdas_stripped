...
# INSERTPAR -- Insert parameter values into model string for evaluation
# by EVALCHI2

procedure insertpar(par, model )
...
begin
	...
	do ic = 1, npar {
	   # Turn par[ic] into a character string
	   call sprintf( chpar, SZ_FNAME, "%g")
	      call pargr( par[ic] )
