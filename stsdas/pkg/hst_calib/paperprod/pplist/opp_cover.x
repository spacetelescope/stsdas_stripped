# Create the cover page for STIS paper product 

define  SZ_TITLE        40

procedure opp_cover(fd, propid, visit, last_name, first_name, title1, title2,
			timetag, page)
...
begin
	...
	# print the banner
	call pp_banner (fd, "", "cover", "", "STIS", timetag, page)
	...
	# print the banner
	call pp_banner (fd, "", "", "", "STIS", timetag, page)
