# Create the cover page of NICMOS paper product

define	SZ_TITLE	40

procedure npp_cover(fd, propid, visit, last_name, first_name, title1, title2,
			timetag, page)
...
begin
	...
	# print the banner
	call pp_banner (fd, "", "cover", "", "NICMOS", timetag, page)
