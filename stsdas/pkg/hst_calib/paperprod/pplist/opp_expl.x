# Create the explanation page for the STIS paper product 

procedure opp_expl (fd)
...
begin
	...
	yoff = yoff + 2
	    ...
	    call pargr (small)
	call pp_label (fd, x2, yoff, 
	  "This Observation Statistics table contains a simple set of")
	call pp_label (fd, x2, yoff+1, 
	  "statistics of the raw (or flat-fielded) data for the observations.")
