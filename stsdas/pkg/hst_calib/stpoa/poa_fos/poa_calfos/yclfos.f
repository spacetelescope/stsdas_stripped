...
*     1.2       Jul 01  A. Alexov       V1.2 of poa_calfos pipeline
*     1.2.1     Oct 01  A. Alexov       V1.2.1 of poa_calfos pipeline
*     1.2.2     Jan 02  A. Alexov       V1.2.2 of poa_calfos pipeline:  mirrored
*                                       updates with 'calfos' - Changed PFLAGS 
*                                       values to SKIPPED from OMIT when 
*                                       appropriate.  Moved scatted light off
*                                       switch to the POA pre-processor.
*-------------------------------------------------------------------------------
C
C     Version number
C
      CHARACTER*14 VERSN
      PARAMETER (VERSN = '1.2.2-Feb-2002')
C
...
C
        CONTXT='*** POA_CALFOS - Version '//VERSN//' ***'
...
C
        CONTXT='Begin POA_CALFOS for input file rootname: '//ROOT
