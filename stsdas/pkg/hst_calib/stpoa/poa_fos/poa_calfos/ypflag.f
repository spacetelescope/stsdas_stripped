...
*     /////////////////////////////////////////////////////////////////////
*     1.2.1     Sep 01  A. Alexov       APR_CORR is to be ignored if WAV_CORR=OMIT
*                                       Scattered light correction = OMIT (always)
*     1.2.2     Jan 02  A. Alexov       Update to match 'calfos' changes:
*                                       flux switched are to be set to SKIPPED, not
*                                       OMIT, if WAV_CORR=OMIT.
*-------------------------------------------------------------------------------
*
* Inputs:
*       grndmd - ground mode
...
C set the sensitivity degradation (time) correction to SKIPPED if the WAV_CORR=OMIT
