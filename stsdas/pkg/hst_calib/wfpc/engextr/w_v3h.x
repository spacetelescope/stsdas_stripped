...
#  w_v3h -- extract wfpc engineering data listed in Table V-3h
#
#  Description:
#  ------------
#  
...
#------------------------------------------------------------------------------
procedure w_v3h (indata, msb, lsb, inmask, tp, colidn, errval, nrows)
...
begin
	...
	call strcpy ("W07U190A",	mnemonic, SZ_MNEMONIC)
