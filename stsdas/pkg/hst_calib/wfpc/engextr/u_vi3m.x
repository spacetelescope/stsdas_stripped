...
#  u_vi3m -- extract wfpc2 engineering data listed in Table VI-3m
#
#  Description:
#  ------------
#  
...
#  ----		------			-----------
#  08-Dec-1993  J.-C. Hsu		adapted from w_v3i.x
#------------------------------------------------------------------------------
procedure u_vi3m (indata, msb, lsb, inmask, tp, colidn, errval, nrows)
...
begin
	...
	call strcpy ("U07U210A",	mnemonic, SZ_MNEMONIC)
	do k = 1, 14 {
	    m = 10 + k - 1
	    j1 = m / 10
	    j2 = mod(m, 10)
