...
**				(Version 3.0)
** H.Bushouse	16-Feb-1998	Added ZEROSIG dq flag value and changed
**				BAD_BACK dq macro to GROT (Version 3.2)
** H.Bushouse	01-Oct-1998	Added USER and RESERVED dq flag values
**				(Version 3.3)
** H.Bushouse	05-Oct-1998	Added n_kwwarn function definition (Version 3.3)
*/
...
# define	HIGH_CURVATURE	16384	/* High curvature in ramp */
...
void	n_kwwarn  (char *, char *);	/* keyword warning */
