...
#* B.Simon	22-Sep-92	extracted from get_em_data

# EMTITLE -- Print title information for EM method linear regression

procedure emtitle (tp, section, nvar, first)
...
string	header  " *** Regression Analysis by EM Algorithm ***\n"
