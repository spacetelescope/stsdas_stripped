...
#* B.Simon	10-Nov-92	extracted from get_bj_data

# BJTITLE -- Print title information for Buckley-James linear regression

procedure bjtitle (tp, section, nvar, first)
...
string	header  " *** Linear Regression by Buckley-James Method ***\n"
