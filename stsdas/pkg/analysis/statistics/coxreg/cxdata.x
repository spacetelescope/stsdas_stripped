...
#* B.Simon	19-Nov-92	revised version of get_cx_data

# CXDATA -- Data input routine for EM method linear regression

int procedure cxdata (tp, section, ind, x, y, nvar, ntot)
...
#--
int	ic, status, junk, ncol, isign, icol, irow
