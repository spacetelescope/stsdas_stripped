...
# GETCXDATA -- Subroutine get_cx_data adapted from the ASURV routine datain
# and datreg/xdata AND with apologies to the columns task in IRAF. 
# This routine reads data from the input file for the Cox method multivariate 
# problem.  The input file may be either an ascii text or a table file.

int procedure get_cx_data (filename, section, ind, x, y, nvar, ntot)
