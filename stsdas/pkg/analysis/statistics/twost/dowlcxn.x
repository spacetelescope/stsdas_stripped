...
# DO_WLCXN -- Do Gehan's generalized Wilcoxon test with hypergeometric variance

procedure do_wlcxn (verbose, isign, id1, id2, xy, n1, n2, ncomp, ntot)
...
begin
	...
	call wlcxn (id1, id2, xy, n1, n2, ncomp, ntot, test, prob,
	...
	if (verbose) {
		...
		if (Memd[r+j] == 0.0) {
		    ...
		    temp2 = Memd[r+j] * (Memd[d2+j] - 
			    (Memd[r2+j] * Memd[d+j] / Memd[r+j]))
		}
