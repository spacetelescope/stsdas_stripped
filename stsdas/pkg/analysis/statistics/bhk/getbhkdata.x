...
# GETBHKDATA -- Subroutine get_bhk_data adapted from the ASURV routine datain
# and datreg/xdata AND with apologies to the columns task in IRAF. 
# This routine reads data from the input file for the BHK method bivariate 
# problem.  The input file may be either an ascii text or a table file.

int procedure get_bhk_data (filename, section, ind, x, y, ntot)
