...
#* B.Simon	18-Nov-92	extracted from get_bhk

# BHKTITLE -- Print title information for BHK method

procedure bhktitle (tp, section, first)
...
string	header  " *** Correlation Test by Generalized Kendall`s Tau ***\n"
