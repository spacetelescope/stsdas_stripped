# GSKY_MODE -- Procedure to compute the mode from the histogram.

# Adapted from images$iminfo/t_imstat.x
# Dec-05-1995	J.-C. Hsu
# Jun-12-1996   Copied straight from xcrrej (I.Busko)

procedure gsky_mode (histgrm, nbins, hwidth, hmin, hmax, mode)
