...
# Phil Hodge, 14-Mar-2001		Check for column not found.
#--
...
errchk	tbtopn, tbcgtr, gtextcoord, immap, imgnlr
...
begin
	...
	if ( pt != NULL) {
	    ...
	    if (colptr == NULL) {
		call eprintf ("Column `%s' not found in table `%s'\n")
		    call pargstr (tcol)
		    call pargstr (input)
